...
**Après réussite du jet de CON DD10**

|d8|Effet|
|---|---|
|1|**Clarté surnaturelle** — Avantage PERCEPTION/INVESTIGATION pendant quelques heures.|
|2|**Respiration profonde** — Avantage contre fatigue, poison ou épuisement temporaire.|
|3|**Vision des flux** — Perçoit brièvement magie végétale, racines, traces de Selve.|
|4|**Réveil physique** — Corps plus fluide : +3m déplacement ou avantage sur un jet DEX.|
|5|**Éveil instinctif** — Sent intuitivement danger, mensonge ou hostilité proche.|
|6|**Écho mémoriel** — Revit un souvenir oublié ou obtient une vision symbolique.|
|7|**Résonance lunaire** — Objets magiques / symboles / idoles réagissent au PJ.|
|8|**Communion végétale** — Comprend instinctivement plantes, croissance ou terrain vivant.|

---

## ☠️ Khar — Effets Négatifs (d4)

**Après échec du jet de CON DD10**
